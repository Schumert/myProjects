...
public class Carpma {
	...
	public static void main(String[] args) {
		...
		/* klavyeden girilen 2 pozitif tam sayıyı, çarpma operatörü kullanmadan çarpan program.
		 * 
		 * 1. Başla
		 * 2. Oku deger1 ve deger2.
		 * 3. toplam = 0.
		 * 4. i = 1.
		 * 5. toplam += deger1
		 * 6. i++.
		 * 7. Eğer deger2<=i ise 4'e git.
		 * 8. Yazdir "deger1 + " * " + deger2 + " = " + toplam. 
		 */ 
